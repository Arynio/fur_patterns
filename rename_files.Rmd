...
T_PATH=/Users/Dani/ownCloud/publico/fur_patterns/fotos/toy #toy path
D_PATH=/Users/Dani/ownCloud/publico/fur_patterns/fotos/acebuche_raw #acebuche raw pictures path
...
#The following loop deletes dots from the filenames and replaces whitespaces with underscores:
cd $D_PATH
shopt -s extglob #the extglob shell option gives you more powerful pattern matching in the command line
declare INDIVIDUALS=$(ls -rth | sort | uniq) #selects all folders except for the calibration one
...
declare INDIVIDUALS=$(ls -rth | sort | uniq)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  mv ${i} ${i// /_}
